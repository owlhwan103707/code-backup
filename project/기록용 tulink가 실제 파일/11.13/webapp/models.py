...
class UserTulink(models.Model):
    current_major = models.CharField(max_length=255)  # 현재 소속 전공
    tutoring_major = models.CharField(max_length=255)  # 튜터링할 전공
    tutoring_sub_major = models.CharField(max_length=255, null=True, blank=True)  # 튜터링할 세부 전공
