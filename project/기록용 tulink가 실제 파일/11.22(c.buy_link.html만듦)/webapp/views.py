...
def buy_link_view(request):
    ...
    discounted_prices = {
        ...
        10: int(link_prices[10] * (0.83 if usage_count.usage_count > 49 else 0.93)),
...
def scan_qr_view(request):
    link_count = request.GET.get('count')
    link_price = request.GET.get('price')
    return render(request, 'webapp/scan_qr.html', {'link_count': link_count, 'link_price': link_price})
