...
from .models import User, UserTulink, TutoringRequest, Payment, Feedback, Major, Link  # 모델들 임포트
...
@admin.register(UserTulink)  # UserTulink 모델 등록
class UserTulinkAdmin(admin.ModelAdmin):
    ...
    # 검색 가능 필드 정의
    list_filter = ('current_major', 'tutoring_major', 'available_days')
    # 필터링 가능한 필드 정의
