        ...
        if request.method == 'POST':
            ...
            send_mail(
                ...
                message=(
                    ...
                    ##
                    f"              <<예약정보>>\n\n"
                    f"{tutor.name}의 전공: {tutor.my_current_major}\n"
                    f"{tutor.name}의 세부 전공: {tutor.my_tutoring_sub_major}\n"
                    ##
                    f"{current_user.name}님의 예약 시간: {selected_time_slot}\n"
            ...
            send_mail(
                ...
                message=(
                    ...
                    f"- 튜터 전공: {current_user.my_current_major}\n"
