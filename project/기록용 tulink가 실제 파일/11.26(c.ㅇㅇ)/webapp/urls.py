...
urlpatterns = [
    ...
    path('delete_account/', views.delete_account_view, name='delete_account'),#회원탈퇴를 위한 뷰
    ...
    path('reserve_tutor/<int:user_id>/', views.reserve_tutor_view, name='reserve_tutor'), #튜터 예약 신청페이지
    path('complete/', views.complete_view, name='complete'),  # 완료 페이지


    path('tutoring/submit/<int:user_id>/', views.tutoring_submit, name='tutoring_submit'), #신청하기 모달창
